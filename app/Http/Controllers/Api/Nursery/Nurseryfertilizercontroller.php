...
class NurseryFertilizerController extends Controller
{
    ...
    {
        $fertilizers = NurseryFertilizer::where('user_id', $request->user()->id)
            ->orderBy('name')
            ->get();
        ...
        return response()->json([
            'success' => true,
            'data'    => $fertilizers,
            'summary' => ['total' => $fertilizers->count()],
        ]);
    }
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $fertilizer = NurseryFertilizer::create([
            ...$validated,
    ...
    {
        $fertilizer = NurseryFertilizer::where('user_id', $request->user()->id)
            ->findOrFail($id);
