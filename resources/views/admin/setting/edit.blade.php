...
<div class="container-fluid py-4">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            <h4 class="mb-0 fw-bold">✏️ Edit Settings</h4>
            <small class="text-muted">Update your application settings below</small>
        </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="url"
                               ...
                               value="{{ old('join_commuity_url', $setting->join_commuity_url) }}"
                               required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="url"
                               ...
                               value="{{ old('developer_portal_url', $setting->developer_portal_url) }}"
                               required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="url"
                               ...
                               value="{{ old('rate_app_url', $setting->rate_app_url) }}"
                               required>
                        @error('rate_app_url')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="url"
                               ...
                               value="{{ old('video_tutorial_video_url', $setting->video_tutorial_video_url) }}">
                        ...
                        @if($setting->photo)
                            <div class="mb-3">
                                ...
                                <img src="{{ asset('uploads/setting/' . $setting->photo) }}"
                                     ...
                                     style="max-height: 160px; max-width: 260px; object-fit: cover;">
                            </div>
                        @endif
    ...
    function previewPhoto(event) {
        ...
        if (file) {
            ...
            reader.onload = function(e) {
                ...
                // Dim the current photo to indicate it will be replaced
